...
urlpatterns = [
    ...
    path('person/legal/delete/<int:pk>', views.LegalPersonDeleteView.as_view(), name='legal_person_delete'),
    ...
    path('person/natural/delete/<int:pk>', views.NaturalPersonDeleteView.as_view(), name='natural_person_delete'),
